...
import authorData from "./author-data.json"; // Import the author data

const Edit = (props) => {
  const { attributes, setAttributes } = props;
  const { selectedAuthor } = attributes;
  ...
  const selectedAuthorData = authorData.find(
    (author) => author.value === selectedAuthor
  );
  ...
  return (
    <Fragment>
      <InspectorControls>
        <PanelBody
          title={__("Author Settings", "gutenberg-block-addons")}
          initialOpen={true}
        >
          <SelectControl
            label={__("Select Author", "gutenberg-block-addons")}
            value={selectedAuthor}
            options={authorOptions.map(({ label, value }) => ({
              label,
              value,
            }))}
      ...
      <div {...useBlockProps()}>
        {selectedAuthorData ? (
            ...
            <div className="author-flex">
              <div className="author-data">
                ...
                <div className="adata">
                  ...
                  <h3 className="atitle">
                    <a href={selectedAuthorData.profileLink}>
                      {selectedAuthorData.name}
                    </a>
                  </h3>
                  <p className="designation">
                    {selectedAuthorData.designation}
                  </p>
                </div>
              </div>
              <div className="author-extra">
                ...
                <div className="extra-content">
                  <p>
                    The information is current and up-to-date in accordance with
          ...
          <div>
            <h4>{__("No Author Selected", "gutenberg-block-addons")}</h4>
            <p>
              {__(
                "Please select an author from the settings panel.",
